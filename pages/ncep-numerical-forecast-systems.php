				...
				<div class="row">
					<div class="col-lg-12">
						<div class="col-lg-3 left-side-bar">
							<ul class="list-group">
								<li class="list-group-item"><a href="/emc/pages/guidance-systems.php">Guidance Systems</a></li>							
    							<li class="list-group-item"><a href="/emc/pages/ncep-numerical-forecast-systems.php" class="see-link">NCEP Numerical Forecast/Analysis Systems</a>
            						<ul class="list-group">
